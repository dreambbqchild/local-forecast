...
do
    INDEX=$(printf "%02d" $i)
    curl "https://nomads.ncep.noaa.gov/cgi-bin/filter_hrrr_2d.pl?file=hrrr.t${HOUR}z.wrfsfcf$INDEX.grib2&all_lev=on&all_var=on&subregion=&leftlon=-93.550505&rightlon=-92.852469&toplat=45.184381&bottomlat=44.468505&dir=%2Fhrrr.$TIME_STAMP%2Fconus" -o  $CURRENT_DIR/build/data/hrrr-$INDEX.grib2 &
