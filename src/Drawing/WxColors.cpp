...
WxColor ColorFromPrecipitation(PrecipitationType precipitationType, double rate)
{
    ...
    if((precipitationType & PrecipitationType::Snow) == PrecipitationType::Snow)
    {
        ...
        if(TestDouble(rate)) return {0, 128, 225}; //20
    }
    else if((precipitationType & PrecipitationType::FreezingRain) == PrecipitationType::FreezingRain)
    {
        ...
        if(TestDouble(rate)) return { 229,  82,  69}; //20
    }
    else
    {
        ...
        if(TestDouble(rate)) return {0, 170, 0}; //20
    }
...
WxColor ColorFromWind(double velocity)
{
    ...
    WIND_COLOR(40, 253, 135, 36);
    WIND_COLOR(35, 253, 168, 38);
    WIND_COLOR(30, 254, 213, 48);
    WIND_COLOR(25, 254, 249, 55);
    WIND_COLOR(20, 216, 249, 52);
    WIND_COLOR(15, 177, 248, 50);
    WIND_COLOR(10, 139, 247, 48);
    WIND_COLOR( 5,  95, 231, 45);

    return {42, 247, 45, 255};
}